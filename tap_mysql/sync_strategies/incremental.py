...
def sync_table(mysql_conn, catalog_entry: singer.CatalogEntry, state, columns, batch_config=None):
    common.whitelist_bookmark_keys(BOOKMARK_KEYS, catalog_entry.tap_stream_id, state)

    stream_metadata = catalog_entry.metadata.root

    replication_key_metadata = stream_metadata.replication_key
    ...
    activate_version_message = singer.ActivateVersionMessage(stream=catalog_entry.tap_stream_id, version=stream_version)
                ...
                with open_conn.cursor() as cur:
                    ...
                    if replication_key_value is not None:
                        if (
                            ...
                            and catalog_entry.schema.properties[replication_key_metadata].format == 'date-time'
